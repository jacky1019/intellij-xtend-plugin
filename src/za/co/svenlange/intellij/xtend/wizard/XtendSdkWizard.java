...
import za.co.svenlange.intellij.xtend.config.XtendLibraryDescription;
 ...
 * @since 2013-11-17
 */
public abstract class XtendSdkWizard extends ModuleWizardStep {
    ...
    public XtendSdkWizard(WizardContext wizardContext) {
    ...
    public JComponent getComponent() {
        ...
        final JLabel caption = new JLabel("Please specify Xtend SDK");
    ...
    private synchronized LibraryOptionsPanel getPanel() {
        if (myPanel == null) {
            final XtendLibraryDescription libraryDescription = new XtendLibraryDescription();
