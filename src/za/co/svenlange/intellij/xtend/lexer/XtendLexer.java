/* The following code was generated by JFlex 1.4.3 on 3/22/13 1:32 PM */
 ...
 * on 3/22/13 1:32 PM from the specification file
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        case 10: 
          ...
          System.out.println("action [194] { return XtendTypes.STRING; }");
          { return XtendTypes.STRING;
          }
        case 12: break;
        case 6: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [201] { throw new RuntimeException(\"Unterminated string at end of line\"); }");
          { throw new RuntimeException("Unterminated string at end of line");
          }
        case 13: break;
        case 7: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [184] { yybegin(YYINITIAL); return XtendTypes.STRING; }");
          { yybegin(YYINITIAL); return XtendTypes.STRING;
          }
        case 14: break;
        case 9: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [200] { throw new RuntimeException(\"Illegal escape sequence \\\"\"+yytext()+\"\\\"\"); }");
          { throw new RuntimeException("Illegal escape sequence \""+yytext()+"\"");
          }
        case 15: break;
        case 5: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [186] { /*stringBuffer.append(yytext());*/ }");
          { /*stringBuffer.append(yytext());*/
          }
        case 16: break;
        case 8: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [69] { return XtendTypes.KEYWORD; }");
          { return XtendTypes.KEYWORD;
          }
        case 17: break;
        case 1: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [205] { return TokenType.BAD_CHARACTER; }");
          { return TokenType.BAD_CHARACTER;
          }
        case 18: break;
        case 4: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [162] { yybegin(STRING); }");
          { yybegin(STRING);
          }
        case 19: break;
        case 11: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [177] { return XtendTypes.COMMENT; }");
          { return XtendTypes.COMMENT;
          }
        case 20: break;
        case 2: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [180] { return TokenType.WHITE_SPACE; }");
          { return TokenType.WHITE_SPACE;
          }
        case 21: break;
        case 3: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [141] { return XtendTypes.BUCHSTABEN; }");
